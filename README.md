...
* Python is a simple and powerful programming language used for web development, data analysis, and automation.
* It has easy syntax and many built-in libraries, making it beginner-friendly.

3.2 Installing Python
<img width="866" height="189" alt="Screenshot 2025-10-13 182538" src="https://github.com/user-attachments/assets/1963044e-b1cb-4ba6-85ae-2d94120dfc60" />
...
# Data type Numbers: Used to store numeric values
# Eg:
* int (10,5)
* float(1.2,3.3)
* complex(7+5j)
